...
const styles = StyleSheet.create({
  ...
  content: { width: "100%", maxWidth: 400, backgroundColor: colors.surfaceContainerLowest, borderRadius: 16, paddingBottom: 12 },
  inlineContent: { maxWidth: "100%", width: "100%", borderRadius: 24, paddingBottom: 10 },
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: colors.surfaceContainerLow },
  ...
  monthText: { fontSize: 15, fontFamily: fonts["600"], color: colors.onSurface },
  dayHeaderRow: { flexDirection: "row", paddingHorizontal: 12, marginBottom: 4 },
  dayHeaderText: { flex: 1, textAlign: "center", fontSize: 11, fontFamily: fonts["600"], color: colors.onSurfaceVariant },
  calendarGrid: { flexDirection: "row", flexWrap: "wrap", paddingHorizontal: 12, marginBottom: 8 },
  dayCell: { width: "14.28%", height: 36, justifyContent: "center", alignItems: "center" },
  dayButton: { width: 32, height: 32, borderRadius: 6, justifyContent: "center", alignItems: "center" },

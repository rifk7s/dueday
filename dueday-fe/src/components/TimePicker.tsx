...
const styles = StyleSheet.create({
  ...
  timeText: { fontSize: 40, fontWeight: "700", color: colors.primaryContainer },
  ...
  pickerLabel: { fontSize: 12, fontWeight: "600", color: colors.onSurfaceVariant, marginBottom: 4 },
  ...
  pickerItemText: { fontSize: 16, fontWeight: "500", color: colors.onSurfaceVariant },
  pickerItemTextActive: { color: colors.primaryContainer, fontWeight: "700" },
  divider: { marginHorizontal: 8, justifyContent: "center", alignItems: "center", height: 250 },
  dividerText: { fontSize: 28, fontWeight: "700", color: colors.onSurface },
  ...
  cancelText: { fontSize: 13, fontWeight: "600", color: colors.onSurface },
  confirmButton: { flex: 1, paddingVertical: 10, borderRadius: 8, backgroundColor: colors.primaryContainer, alignItems: "center" },
  confirmText: { fontSize: 13, fontWeight: "600", color: colors.onPrimary },
});
